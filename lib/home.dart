...
import 'package:networkfinder/change_ip.dart';
import 'package:networkfinder/global_variables.dart';
...
class LinuxAppHome extends StatefulWidget {
  ...
  const LinuxAppHome({super.key, required this.deviceip});
  @override
